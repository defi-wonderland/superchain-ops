...
contract LateOptInRevenueShare is SimpleTaskBase {
    ...
    address internal immutable SEQUENCER_FEE_WALLET = Predeploys.SEQUENCER_FEE_WALLET;
    /// @notice Address of the L1 Fee Vault Predeploy on L2.
    address internal immutable L1_FEE_VAULT = Predeploys.L1_FEE_VAULT;
    /// @notice Address of the Base Fee Vault Predeploy on L2.
    address internal immutable BASE_FEE_VAULT = Predeploys.BASE_FEE_VAULT;
